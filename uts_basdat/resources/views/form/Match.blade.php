...
<body>
                              ...
                              @csrf
                                    ...
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3">
                                            <div class="x-dropdown dropdown">
                                              <select class="form-control input input-tr" name="kompetisi" id="kompetisi">
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        ...
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" type="date" name="tanggal">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-l form-group mb-3"><input class="form-control input input-tr" type="text" required="" placeholder="Jumlah penonton" name="jumlahPenonton">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                      <div class="form-group">
                                          <label for="timTuanRumah">Tim Tuan Rumah</label>
                                          <select name="TimTuanRumah" id="timTuanRumah" class="form-control">
                                    ...
                                    <div class="col col-contact">
                                      <div class="form-group">
                                            <label for="timTamu">Tim Tamu</label>
                                            <select name="timTamu" id="timTamu" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" type="text" required="" placeholder="Skor Tuan Rumah" name="skorTuanRumah">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col col-contact">
                                        <div class="modern-form__form-group--padding-l form-group mb-3"><input class="form-control input input-tr" type="text" required="" placeholder="Skor tamu" name="skorTamu">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
    ...
    <script>
        document.getElementById('kompetisi').addEventListener('change', function () {
            ...
            const timTuanRumahSelect = document.getElementById('timTuanRumah');
            const timTamuSelect = document.getElementById('timTamu');

            // Hapus semua opsi sebelum menambahkan yang baru
            timTuanRumahSelect.innerHTML = '';
            timTamuSelect.innerHTML = '';

            if (selectedKompetisi) {
                // Menambahkan opsi tim tuan rumah dan tamu sesuai dengan kompetisi yang dipilih
                @foreach ($timList as $tim)
                    if ('{{ $tim->ID_Kompetisi }}' == selectedKompetisi) {
                        const option = document.createElement('option');
                        option.value = '{{ $tim->ID_Tim }}';
                        option.text = '{{ $tim->Nama_Tim }}';

                        // Duplikat opsi untuk tim tamu
                        const optionTamu = option.cloneNode(true);

                        timTuanRumahSelect.appendChild(option);
                        timTamuSelect.appendChild(optionTamu);
                    }
                @endforeach
            }
        });
