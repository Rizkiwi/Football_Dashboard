        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><i class="fa fa-soccer-ball-o" style="font-size: 14px;"></i></span><span>Bola Talent Hub</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="Berita">News</a></li>
                </ul>
                ...
                <section class="getintouch">
                    <div class="container modern-form" style="padding-top: 0px;">
                        <div class="text-center">
                            <h4 style="color: #212529;font-size: 45px;">Berita</h4>
                        </div>
                            ...
                            <form action="{{ route('storenews') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="file" class="form-control" id="gambar_berita" name="gambar_berita" onchange="previewImage(event)">
                                    </div>
                                    <div class="col-lg-6">
                                        <img id="image-preview" src="{{ asset('news/default-image.png') }}" alt="Preview Gambar" style="border-radius: 0;width: 400px;height: 300px;margin: 0px;margin-bottom: 19px;padding-right: 0px;padding-bottom: 0px;padding-left: 0px;">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea id="isi_berita" name="isi_berita" rows="4" cols="50" class="form-control"></textarea>
                                    </div>
                                </div>
                            ...
                            <!-- <form action="{{ route('storenews') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col d-flex d-lg-flex justify-content-center align-items-center align-content-center justify-content-lg-center align-items-lg-center" style="width: 630px;position: relative;display: flex;padding-left: 30px;padding-right: 30px;">
                                        <label for="gambar_berita" style="margin-right: 152px;">Gambar Berita:</label><br>
                                        <input type="file" class="form-control form-control" style="width: 400px;" id="gambar_berita" name="gambar_berita"><br><br>
