                            ...
                            <form action="{{ route('kompetisi') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        ...
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" placeholder="Tanggal_Mulai" type="date" name="Tanggal_Mulai" id="Tanggal_Mulai">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col col-contact">
                                        ...
                                        <div class="modern-form__form-group--padding-r form-group mb-3"><input class="form-control input input-tr" placeholder="Tanggal_Berakhir" type="date" name="Tanggal_Berakhir" id="Tanggal_Berakhir">
                                            <div class="line-box">
                                                <div class="line"></div>
                                            </div>
                                        </div>
